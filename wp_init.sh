...
wp core install --url=http://localhost:${PORT} --title=neopa --admin_user=admin --admin_password=root --admin_email=contact@neopa.jp --path=/home/kusanagi/kusanagi/DocumentRoot/
...
case "\$ANSWER1" in
    "" | "Y" | "y" | "yes" | "Yes" | "YES" )
      ...
      --activate \
      --path=/home/kusanagi/kusanagi/DocumentRoot/
      ;;
    * ) echo "プラグインはいれてないよ〜";;
esac
EOT
echo "- ほな./compose.sh start叩いたってや！"
